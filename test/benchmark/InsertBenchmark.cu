...
const uint32_t TOTAL_NUM = 10000000; // 50 million
...
int main() {
	...
	createDeviceHashTable(dht, TOTAL_NUM * 10, TOTAL_NUM/2, sizeof(uint32_t), sizeof(uint32_t));
